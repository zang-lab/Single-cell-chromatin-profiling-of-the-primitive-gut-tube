#signal file pair
filename.li <- list(c("E95_intestine.peak_1bin.bed","E135_intestine.peak_1bin.bed"),c("E95_pancreas.peak_1bin.bed","E135_pancreas.peak_1bin.bed"),c("E95_stomach.peak_1bin.bed","E135_stomach.peak_1bin.bed"),c("E95_lung.peak_1bin.bed","E135_lung.peak_1bin.bed"))
names(filename.li) <- c("E95intestine_E135intestine","E95pancreas_E135pancreas","E95stomach_E135stomach","E95lung_E135lung")

signal_dir="/scratch/hz9fq/toronto_project/E95E135_CrossStages/signal_mergedPeaks_1129/"
